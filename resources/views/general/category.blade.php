                ...
                <div class="row">
                    @for ($i = 1; $i <= 4; $i++)
                        <div class="col-6 col-md-3 mb-4">
                            <div class="card product-card h-100">
                                <img src="https://picsum.photos/300/400?random={{ $i + 50 }}"
                                    class="card-img-top" alt="Recently Viewed {{ $i }}"
                                    style="height: 200px; object-fit: cover;">
                                <div class="card-body">
                                    <h6 class="card-title">
                                        {{ ['Etawalin Premium', 'Etawaku Gold', 'Suplemen Plus', 'Vitamin Complete'][$i - 1] }}</h6>
                                    <p class="card-text text-muted small">Sigma
                                    </p>
                                    <div class="fw-bold">Rp {{ number_format([185000, 225000, 145000, 165000][$i - 1]) }}</div>
                                </div>
                            </div>
                        </div>
                    @endfor
